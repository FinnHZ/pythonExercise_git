...
asciiCommand = b'\x01\x03\x00\xfc'   #!!!!!it works this is the ASCII form in python (\01  --> \x01)
# asciiCommand = b'STX B10 fd ETX'   #!!!!!it works this is the ASCII form in python (\01  --> \x01)
