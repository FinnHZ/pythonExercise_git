...
client = ModbusSerialClient(method = "rtu", port = "COM3", stopbits = 1, bytesize = 8, parity = 'N', baudrate = 9600)
print("Connect------------------------------------------")
...
# testStateClient = client.read_input_registers(address=2000, count=countNUm, slave=1)  #address=599
...
# changeState = client.write_registers(slave=1, address=1, values=[4])
changeState = client.write_register(slave=1, address=1, value=8)



# print(client.read_coils(address=1, count=1, slave=1))
...
# #The dictionaries below will be imported from user interface file.>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
#             #     if distribute_flag == iUnpackMax-1:   #this number should be 1 less than iUnpackMax
#             #         a = oneRegister[0]
#             #         b = oneRegister[1]
...
#                     # a1 = "{0:b}".format(a).zfill(8)
#                     # b1 = "{0:b}".format(b).zfill(8)
#                     # d1 = "{0:b}".format(d).zfill(8)
#                     # e1 = "{0:b}".format(e).zfill(8)
...
# #             for k1 in productParaItems_diagram:
...
# #                 # print(str(int(reigster40600Start[productParaItems_diagram[k1][0]][int(productParaItems_diagram[k1][1]):int(productParaItems_diagram[k1][2])], 2)))
...
# #                 # print(str(int(reigster40600Start[productMeasureItems_diagram[k2][0]][int(productMeasureItems_diagram[k2][1]):int(productMeasureItems_diagram[k2][2])], 2)))
