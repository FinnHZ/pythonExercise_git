...
# from modebusRTU_test_dynamic_userinterface import userInterface
...
productParaItems = {
    "StarterState":[None, None, None],
    "TripCode":[None, None, None],
    "Initialisation":[None, None, None],
    "CommandSource":[None, None, None],
    "ParametersChange":[None, None, None],
    "PhaseSequence":[None, None, None],
    "Versions_Product":[None, None, None],
    "Versions_Model":[None, None, None],
    "PowerScale": [None, None, None],
    "DigitalInput_StartStop": [None, None, None],
    "DigitalInput_Reserved": [None, None, None],
    "DigitalInput_Reset": [None, None, None],
    "DigitalInput_InputA": [None, None, None],
    "DigitalInput_InputB": [None, None, None]
}


productMeasureItems = {
    "Average3phRmsCurrent":[None, None, None],
    "Average3phRmsVoltage":[None, None, None],
    "CurrentMotorFLC":[None, None, None],
    "MotorThermalModel":[None, None, None],
    "PowerFactor":[None, None, None],
    "Current_P1":[None, None, None],
    "Current_P2":[None, None, None],
    "Current_P3":[None, None, None],
    "Voltage_P1":[None, None, None],
    "Voltage_P2":[None, None, None],
    "Voltage_P3":[None, None, None],
    "Versions_Binary":[None, None, None],
    "Versions_ParamList":[None, None, None]
}
