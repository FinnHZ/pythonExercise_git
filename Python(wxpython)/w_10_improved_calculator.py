...
#  more advanced calculator  (layout management)
import wx
import time
import os,sys
...
#sys.path.append(os.path.join(cwd,"panel"))  # 这句话的意思是，把 panel名字的子目录 跟到 主目录下面，然后把整个路径添加到系统执行路径中。但是这句话可以替换为最上面的包引入模式，更方便
...
class MainFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        vbox.Add(self.panel.calcResult, 0, 20)   #这里先将 可控文本框 添加到 大盒子里vbox？？？？？？？, wx.ALL|wx.EXPAND|wx.ALIGN_CENTER_HORIZONTAL  ???
